...
- (BOOL)            application:(UIApplication *)application
  didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    //and if the current thread is the main thread, then the main thread will be blocked.
    //If you go on a global concurrent queue with GCD and then initiate a synchronous connection,
    //then you are not blocking the main thread.
