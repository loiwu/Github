...
- (BOOL)            application:(UIApplication *)application
  didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    NSString *urlAsString = @"www.justek.us"; // <# Place the URL of the web server here #>
    ...
    //The first parameter sent in the HTTP body does not have to be prefixed with a question mark,
    //unlike the first parameter in a query string.
