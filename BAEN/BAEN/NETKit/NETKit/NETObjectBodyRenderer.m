...
static const CGFloat NETObjectBodyRendererLinkColor[3] = {9.0 / 255.0, 33 / 255.0, 234 / 255.0};

static CGFloat defaultFontSize = 13.0f;

@implementation NETObjectBodyRenderer
@synthesize object;
...
- (CTFontRef)fontForFont:(UIFont *)font {
    ...
    - (UIColor *)colorFromHexString:(NSString *)hex {
        ...
        - (NSString *)text {
            if ([object isKindOfClass:[NETEntry class]]) {
                NETEntry *entry = (NETEntry *) object;
                return [entry body];
            } else if ([object isKindOfClass:[NETUser class]]) {
                NETUser *user = (NETUser *) object;
        ...
        - (NSAttributedString *)createAttributedString {
            ...
            CGColorRef colorLink = [[UIColor colorWithRed:NETObjectBodyRendererLinkColor[0] green:NETObjectBodyRendererLinkColor[1] blue:NETObjectBodyRendererLinkColor[2] alpha:1.0] CGColor];
#else
            ...
            CGColorRef colorLink = [[NSColor colorWithCalibratedRed:NETObjectBodyRendererLinkColor[0] green:NETObjectBodyRendererLinkColor[1] blue:NETObjectBodyRendererLinkColor[2] alpha:1.0] CGColor];
#endif
        ...
        - (id)initWithObject:(NETObject *)object_ {
            if ((self = [super init])) {
                object = object_;
                [self prepare];
                
                [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(prepare) name:kNETObjectLoadingStateChangedNotification object:object];
            }
