...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [NETNetworkActivityController setNetworkActivityBeganBlock:^{
        [[UIApplication sharedApplication] retainNetworkActivityIndicator];
    }];
    
    [NETNetworkActivityController setNetworkActivityEndedBlock:^{
        [[UIApplication sharedApplication] releaseNetworkActivityIndicator];
    }];
    
    NETSessionController *sessionController = [NETSessionController sessionController];
    NSArray *sessions = [sessionController sessions];
    NETSession *recentSession = [sessionController recentSession];
