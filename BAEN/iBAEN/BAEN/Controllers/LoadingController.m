...
- (void)setSource:(NETObject *)source_ {
    [[NSNotificationCenter defaultCenter] removeObserver:self name:kNETObjectStartedLoadingNotification object:source];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:kNETObjectFinishedLoadingNotification object:source];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:kNETObjectFailedLoadingNotification object:source];
    
    [source autorelease];
    source = [source_ retain];
    
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(sourceStartedLoading) name:kNETObjectStartedLoadingNotification object:source];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(sourceFinishedLoading) name:kNETObjectFinishedLoadingNotification object:source];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(sourceFailedLoading) name:kNETObjectFailedLoadingNotification object:source];
...
- (void)objectChangedLoadingState:(NETObject *)object {
}
